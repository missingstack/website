		...
		<Container>
			...
			<div className="flex flex-col gap-8 lg:flex-row">
				...
				<div className="min-w-0 flex-1">
					...
					{isError && (
						<div className="rounded-2xl bg-destructive/10 py-16 text-center">
							<p className="mb-2 text-destructive">Failed to load tools</p>
					...
					{!isLoading && !isError && allTools.length === 0 && (
						<div className="rounded-2xl bg-secondary/20 py-16 text-center">
							<p className="mb-2 text-muted-foreground">No tools found</p>
							<p className="text-muted-foreground text-sm">

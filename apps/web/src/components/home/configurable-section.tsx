...
export function ConfigurableSection({
	...
	return (
		<section className="border-border/50 border-b py-12 last:border-b-0">
			<div className="mx-auto max-w-7xl px-6">
				<div className="mb-10 flex items-center justify-between">
					<div className="flex items-center gap-4">
						...
						<div>
							<h2 className="mb-1 font-bold font-serif text-2xl text-primary md:text-3xl">
								{config.title}
							</h2>
					...
					<Link
						href={viewAllLink}
						className="flex items-center gap-1.5 font-medium text-primary text-sm hover:underline"
					>
						View all
					...
					<div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
						{tools.slice(0, 2).map((tool) => (
							<Link
								...
								className="group hover:-translate-y-1 relative flex h-full flex-col rounded-2xl border-2 border-border/50 bg-white p-8 transition-all duration-300 hover:border-primary/30 hover:shadow-2xl hover:shadow-primary/10"
							>
					...
					<div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
						{tools.map((tool) => (
							<Link
								key={tool.id}
								href={`/tools/${tool.slug}`}
								className="group hover:-translate-y-1 relative flex h-full flex-col rounded-2xl border border-border/50 bg-white p-6 transition-all duration-300 hover:border-primary/20 hover:shadow-primary/5 hover:shadow-xl"
							>

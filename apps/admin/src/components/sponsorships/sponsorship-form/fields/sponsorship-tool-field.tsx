...
interface SponsorshipToolFieldProps {
	form: UseFormReturn<SponsorshipFormValues>;
	toolOptions?: Array<{ value: string; label: string }>;
}

export function SponsorshipToolField({
	form,
	toolOptions = [],
}: SponsorshipToolFieldProps) {
	...
	return (
		<Field>
			...
			<Combobox
				...
				defaultLimit={10}
			/>
			<FieldDescription>Select the tool to sponsor</FieldDescription>

...
export function EditSponsorshipForm({
	...
	const { data: sponsorshipData, isLoading: isLoadingSponsorship } = useQuery({
	...
	// Populate form when sponsorship data loads
	useEffect(() => {
		if (sponsorshipData) {
			...
			<Drawer open={open} onOpenChange={onOpenChange} direction="right">
				<DrawerContent className="flex h-full flex-col data-[vaul-drawer-direction=right]:max-w-lg! sm:data-[vaul-drawer-direction=right]:max-w-lg!">
					<DrawerHeader className="shrink-0 border-b">
						...
						<DrawerDescription>Loading sponsorship data...</DrawerDescription>
					</DrawerHeader>
